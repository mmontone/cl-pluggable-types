(in-package :decl-type-system)

(defmethod gradual::infer-type (form (type-system (eql 'gradual-type-system)) &rest args)
  "Infer the type of FORM under a fresh TYPING-ENVIRONMENT."
  (let* ((type-system (apply #'make-instance type-system args))
        (env (gradual::make-typing-environment type-system)))
    (values
